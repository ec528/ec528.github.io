...
**Office Hours:** Tuesday 3:30-5:00PM, Wednesday 1:00-2:30 PM, Friday 2:30-4:00 PM, PHO305
...
* 30%: Three project demos
  * Demo 30% breakdown: 15% presentation + 85% project metrics
  * Presentation (15%) is graded per presenter (presentation quality, clarity, engagement)
  * Project metrics (85%) is averaged across three demo scores
  * Demo scoring details:
    * Demo 1: progress 5/8 (62.5%), slides 2/8 (25%), challenge 1/8 (12.5%)
    * Demo 2 and Demo 3: progress 40%, code quality 10%, design doc (including demo content) 20%, slides 10%, novelty 10%
* 30%: Final project result and report
* 5%: project quizzes (checking if you listened to your classmates' presentations)

#### Peer scoring example (5-person team)

Each student scores the other 4 teammates, with total points required to equal 400%.

Example:
- You give A: 80%
- The remaining three members share 320%, e.g., 110% + 110% + 100% (or any combination that averages 100%)

Final individual project score calculation:
- Compute your raw project score = project part + presentation part (e.g., 70 points)
- Multiply by contribution factor (e.g., peer score 120%)
- Example: 70 * 1.2 = 84 (or scale according to course grading caps)
