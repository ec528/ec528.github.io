...
All project deliverables (project description, demo slides, design documents, demo videos, code, and the final report) live in your team's **GitHub repository**, and we grade the version in the repository at each deadline.
...
Late submissions are not accepted. Project descriptions, design documents, demo materials, and the final report must be submitted by their stated deadlines.
