...
Graded per presenter on presentation quality, clarity, and engagement. **At most two team members may present in a single demo**, and every team member must present at least once across the three demos — three demos with two presenters each covers a team of up to six, so a 4-5 person team has room to spare. If you present in more than one milestone demo, we use your **highest presentation score**.
